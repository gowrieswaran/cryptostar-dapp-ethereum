...
//  Add a name and a symbol for your starNotary tokens
    string public name = "My Star Token";
...
//
    ...
    function transferStar(address starReceiver, uint256 _tokenId) public {

        address starOwner = ownerOf(_tokenId);
        approve(starReceiver, _tokenId);
        transferFrom(starOwner, starReceiver, _tokenId);
